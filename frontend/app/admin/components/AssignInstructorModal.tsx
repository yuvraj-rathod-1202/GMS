      ...
      <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {users.map((user) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`p-2 rounded-lg ${instructorId === user.id.toString() ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-400'}`}
                  >
        ...
        <Alert variant="info">
          ...
          <p className="mt-1 text-[11px]">
            Assigning an instructor grants them full access to manage course content and marks for{' '}
            {courseName}.
          </p>
        </Alert>
