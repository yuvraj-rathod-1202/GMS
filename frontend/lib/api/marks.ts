...
export const MarksApi = {
    ...
    GetAssessmentById: async (courseId: number, assessmentId: number) => {
        return handleRequest(
            apiClient.get(`/assessments/${courseId}/${assessmentId}`)
        );
    },

    UpdateAssessment: async (courseId: number, assessmentId: number, data: UpdateAssessmentRequest) => {
        return handleRequest(
            apiClient.put(`/assessments/${courseId}/${assessmentId}`, data)
        );
    },

    DeleteAssessment: async (courseId: number, assessmentId: number) => {
        return handleRequest(
            apiClient.delete(`/assessments/${courseId}/${assessmentId}`)
        );
    },
    ...
    GetAllMarks: async (courseId: number, assessmentId: number) => {
        return handleRequest(
            apiClient.get(`/assessments/${courseId}/${assessmentId}/marks`)
        );
    },
    ...
    PublishMarks: async (courseId: number, assessmentId: number) => {
        return handleRequest(
            apiClient.put(`/assessments/${courseId}/${assessmentId}/publish`)
        );
    },

    UnpublishMarks: async (courseId: number, assessmentId: number) => {
        return handleRequest(
            apiClient.put(`/assessments/${courseId}/${assessmentId}/unpublish`)
        );
    },
