...
describe('grades service', () => {
    ...
    describe('handlePublishToggle', () => {
        ...
        it('should stop event propagation', async () => {
            await handlePublishToggle(mockEvent, mockAssessment, mockSetIsPublishing, mockUnpublishMarks, mockPublishMarks);
        ...
        it('should call PublishMarks when not published', async () => {
            ...
            await handlePublishToggle(mockEvent, mockAssessment, mockSetIsPublishing, mockUnpublishMarks, mockPublishMarks, mockOnPublishToggle);
