                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                        <input
                            ...
                            disabled={isLoading}
                        />
                        <label htmlFor="is_marks_published" className="text-sm text-gray-700 cursor-pointer flex-1">
                            <span className="font-medium">Publish marks immediately</span>
                            <p className="text-xs text-gray-500 mt-0.5">Students will be able to view their marks for this assessment</p>
                        </label>
                    </div>
