...
export default function CoursesStatusSelection({setOpen, open, statusFilter, setStatusFilter} : {setOpen: (open: boolean) => void, open: boolean, statusFilter: "ongoing" | "completed", setStatusFilter: (status: "ongoing" | "completed") => void}) {
    ...
    return (
        <div className="relative">
            ...
            {open && (
            <div
                className="absolute right-0 mt-1 w-full bg-white rounded-md shadow-lg z-20"
            >
