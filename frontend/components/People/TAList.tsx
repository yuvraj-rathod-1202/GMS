    ...
    <div className="space-y-4">
      ...
      {filteredStudents.length === 0 ? (
        <div className="px-4 sm:px-6 py-6 sm:py-8 text-xs sm:text-sm md:text-base text-center text-gray-500">
          {searchQuery ? "No TAs found matching your search" : "No TAs enrolled yet"}
        </div>
      ) : (
        filteredStudents.map((student, index) => (
          ...
          >
            ...
            <div className="relative">
              <button
                onClick={() => setSelectedTA(selectedTA === student.index ? null : student.index)}
