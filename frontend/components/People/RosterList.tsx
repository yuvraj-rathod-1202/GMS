  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 space-y-4">
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-xs">
        {/* Fixed Header */}
        <div
          className="grid gap-4 border-b border-gray-200 bg-gray-50/50 px-4 py-3 text-xs font-semibold text-gray-900 sm:px-6 sm:py-4 sm:text-sm sticky top-0 z-10"
        ...
        <div className="flex-1 overflow-y-auto">
          {filteredItems.length === 0 ? (
            <div className="px-4 py-12 text-center text-gray-500 sm:px-6 sm:py-16">
            ...
            filteredItems.map((item, index) => (
              <div
                key={item.index}
                className={`group grid items-center gap-4 px-4 py-3 text-sm sm:px-6 sm:py-4 hover:bg-gray-50/50 transition-colors ${
              ...
              >
                ...
                <div className="relative text-right">
                  ...
                  {selectedItem === item.index && (
                    <div className="absolute right-0 z-30 mt-1 w-52 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg ring-1 ring-black/5">
                      <button
                        type="button"
